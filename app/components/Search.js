      ...
      <div className="search-overlay-bottom">
        <div className="container container--narrow py-3">
          ...
          <div className={"live-search-results " + (state.show == "results" ? "live-search-results--visible" : "")}>
            ...
            {!Boolean(state.results.length) && <p className="alert alert-danger text-center shadow-sm">sorry, we could not find any results for that search. try another search...</p>}
          </div>
        </div>
      </div>
    </>
